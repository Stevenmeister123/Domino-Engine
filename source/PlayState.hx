...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['dO yOu wAnT tHe fOoKiNG pHoNe?', 0.4], //From 20% to 39%
		['Shit', 0.5], //From 40% to 49%
		['Ugh', 0.6], //From 50% to 59%
		['Eh', 0.69], //From 60% to 68%
		['Hello and welcome back to Behind The Meme', 0.7], //69%
		['Cool', 0.8], //From 70% to 79%
		['Amazing', 0.9], //From 80% to 89%
		['Domino Corp Approves!', 1], //From 90% to 99%
		['Good Luck FCing The Whole Song', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		{
			case 'insert song here':
				credits = 'Insert Credits/Text - Domino Engine (PE V4.2) V1.0.0';
			default:
				credits = 'Domino Engine (PE V4.2) V1.0.0';
		}
		...
		// watermark code from kade engine
		var songWatermark = new FlxText(4, textYPos, 0,
		
		" "
		+ (curSong.toLowerCase() != 'splitathon' ? (storyDifficulty == 3 ? " " : storyDifficulty == 2 ? " " : storyDifficulty == 1 ? " " : " ") : " ")
		+ " ", 16);
		//+ " ", 16);
